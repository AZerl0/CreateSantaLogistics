...
public class RoboElfRenderer extends MobRenderer<RoboElf, RoboElfModel> {
    ...
    private static final ResourceLocation TEXTURE_EXPOSED = SantaConstants.id("textures/entity/exposed_robo_elf.png");
    private static final ResourceLocation TEXTURE_WEATHERED = SantaConstants.id("textures/entity/weathered_robo_elf.png");
    private static final ResourceLocation TEXTURE_OXIDIZED = SantaConstants.id("textures/entity/oxidized_robo_elf.png");
