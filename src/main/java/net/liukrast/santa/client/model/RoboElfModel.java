...
public class RoboElfModel extends EntityModel<RoboElf> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition right_leg = partdefinition.addOrReplaceChild("right_leg", CubeListBuilder.create().texOffs(0, 63).addBox(-2.0F, -1.0F, -2.0F, 4.0F, 8.0F, 4.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition left_leg = partdefinition.addOrReplaceChild("left_leg", CubeListBuilder.create().texOffs(0, 63).mirror().addBox(-2.0F, -1.0F, -2.0F, 4.0F, 8.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false)
        ...
        PartDefinition hat_3 = hat_2.addOrReplaceChild("hat_3", CubeListBuilder.create().texOffs(40, 40).addBox(0.0F, -4.0F, -3.0F, 6.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(3.0F, -2.0F, 0.0F));

        PartDefinition right_arm = body.addOrReplaceChild("right_arm", CubeListBuilder.create().texOffs(48, 52).addBox(-2.0F, -2.0F, 0.0F, 1.0F, 11.0F, 1.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition left_arm = body.addOrReplaceChild("left_arm", CubeListBuilder.create().texOffs(48, 52).mirror().addBox(1.0F, -2.0F, 0.0F, 1.0F, 11.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false)
        ...
        PartDefinition wind = body.addOrReplaceChild("wind", CubeListBuilder.create().texOffs(40, 16).addBox(0.0F, -6.0F, 0.0F, 0.0F, 12.0F, 12.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -12.0F, 5.0F));

        PartDefinition right_ear = body.addOrReplaceChild("right_ear", CubeListBuilder.create().texOffs(0, 49).addBox(-4.0F, -5.0F, 0.0F, 5.0F, 6.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-5.0F, -12.0F, -3.0F, 0.1828F, 0.346F, 0.0475F));

        PartDefinition left_ear = body.addOrReplaceChild("left_ear", CubeListBuilder.create().texOffs(0, 49).mirror().addBox(-1.0F, -5.0F, 0.0F, 5.0F, 6.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(5.0F, -12.0F, -3.0F, 0.1828F, -0.346F, -0.0475F));
