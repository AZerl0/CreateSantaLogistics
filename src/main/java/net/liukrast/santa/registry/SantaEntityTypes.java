...
import net.liukrast.santa.client.renderer.entity.SantaClausRenderer;
...
public class SantaEntityTypes {
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<RoboElf>> ROBO_ELF = REGISTER.register("robo_elf", () -> EntityType.Builder.of(RoboElf::new, MobCategory.CREATURE).sized(0.8f, 1f).build("robo_elf"));
    public static final DeferredHolder<EntityType<?>, EntityType<SantaClaus>> SANTA_CLAUS = REGISTER.register("santa_claus", () -> EntityType.Builder.of(SantaClaus::new, MobCategory.CREATURE).sized(2, 2.8f).build("santa_claus"));
    ...
    public static void registerRenderers(EntityRenderersEvent.RegisterRenderers event) {
        ...
        event.registerEntityRenderer(SANTA_CLAUS.get(), SantaClausRenderer::new);
    }

    @OnlyIn(Dist.CLIENT)
    public static void registerLayerDefinitions(EntityRenderersEvent.RegisterLayerDefinitions event) {
        event.registerLayerDefinition(RoboElfModel.LAYER_LOCATION, RoboElfModel::createBodyLayer);
        event.registerLayerDefinition(SantaClausModel.LAYER_LOCATION, SantaClausModel::createBodyLayer);
    }

    public static void entityAttributeCreation(EntityAttributeCreationEvent event) {
        event.put(ROBO_ELF.get(), RoboElf.createRoboElfAttributes().build());
        event.put(SANTA_CLAUS.get(), SantaClaus.createSantaAttributes().build());
    }
}
